...
var PipeLine = function(offset, size) {
    ...
    this.bot_pipe.x = offset;
    this.bot_pipe.y = 0;

    this.top_pipe.x = offset;
    this.top_pipe.y = size.height;
}


ParallaxLayer.scene = function () {
